...
inspired ddflow spent years fighting: markdown that is simultaneously a human document
...
GENERATED = (
    "<!-- GENERATED by `ddflow render`. Do not edit: the event log is the source of truth. -->"
)
