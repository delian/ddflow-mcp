...
2. `orchard_gate_record <item> dedupe --outcome passed --evidence "<what was merged, what the detector said before and after>"`.
3. `orchard_lesson_add` if the duplication had a cause worth naming — a missing seam, an unclear owner, a helper nobody could find.
