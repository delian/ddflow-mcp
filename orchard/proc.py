...
Orchard runs as an **MCP server over stdio**: the JSON-RPC session IS this process's
...
companion-detection probe added to `orchard setup` ended the MCP session on the very
next tool call.
